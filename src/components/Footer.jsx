    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.meunome}>
                <p>Julia Soares de Morais</p>
            </div>

            <div className={styles.icons}>
                <a href="https://instagram.com/juliasoares_40" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/Julia-40" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://wa.me/5584991814974" target="_blank" rel="noopener noreferrer">
